...
/**
 * @ORM\Table(name="orders_attribue_value", indexes={
 ...
 */
class OrderAttributeValue extends AbstractValue
{

    /**
     * @var DataInterface
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Order", inversedBy="values", fetch="EAGER")
